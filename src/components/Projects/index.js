    ...
    <ProjectsContainer id='projects'>
      ...
      <ProjectsWrapper>
        ...
        <ProjectsCard>
          ...
          <LinkArea>
            <ProjectLink href="https://github.com/Danyboyyy/Sudoku">
              <FaGithub />
            </ProjectLink>
          </LinkArea>
        </ProjectsCard>
        <ProjectsCard>
          ...
          <LinkArea>
            <ProjectLink href="https://github.com/Danyboyyy/Spotifavs">
              <FaGithub />
            </ProjectLink>
            <ProjectLink href="">
              <FaLink />
        ...
        <ProjectsCard>
          ...
          <LinkArea>
            <ProjectLink href="https://github.com/Danyboyyy/Danurls">
              <FaGithub />
            </ProjectLink>
          </LinkArea>
        </ProjectsCard>
